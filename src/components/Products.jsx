...
export const Products = () => {
  ...
  useEffect(() => {
    setBestSellers(["All", "Sneakers", "Camperas", "Morrales", "Conjuntos", "Remeras" ]);
  ...
  return (
    <section className="section product" id="products">
      <div className="container">
        <h2 className="h2 section-title">Nuestros Productos</h2>
            ...
            <li key={index} className="product-item" data-aos="fade">
              <div className="product-card" tabindex="0">
                <figure className="card-banner">
                  ...
                  <span className="price__text">${product.price}</span>
                  </div>
              </div>
            </li>
          ))}
