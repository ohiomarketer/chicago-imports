...
export const Payment = () => {
    ...
    useEffect(() => {
        ...
        setName(localStorage.getItem('name0'));
        setSurname(localStorage.getItem('surname0'));
    }, []);
                    ...
                    <button className="transfer-btn" onClick={() => {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.open('https://www.instagram.com/chicagoimports_/', '_blank');
                                Swal.fire('Redirigido a Instagram', '', 'info');
                            } else if (result.isDenied) {
                                window.open('mailto: importschicago@gmail.com', '_blank');
