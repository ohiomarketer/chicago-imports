      ...
      <div className="container">
        ...
        <div className="footer-brand">
          <ul className="social-list" style={{
            ...
            <li>
              <a href="https://www.instagram.com/chicagoimports_/" target='_blank' className="social-link">
        ...
        <div className="footer-link-box">
          ...
          <ul className="footer-list">
            ...
            <li>
              <address className="footer-link">
                ...
                <span className="footer-link-text">
                  Avenida Medrano, 950, Buenos Aires, Argentina
                </span>
              </address>
            </li>
            ...
            <li>
              <a href="mailto:importschicago@gmail.com" className="footer-link">
                <ion-icon name="mail"></ion-icon>

                <span className="footer-link-text">importschicago@gmail.com</span>
              </a>
            </li>
